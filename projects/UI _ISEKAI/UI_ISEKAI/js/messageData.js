...
let aki = [{
  ...
  "path": "block3",
  "messages": [{
    "text": "**Aki has enabled focused mode. She will not receive a notification for this message. Type 'URGENT' if you would like them to receive a notification for it**",
    "author": "Chat"
  }],
  "choices": [{
      "path": "block3",
...
let musa = [{
    ...
    "messages": [{
      ...
      {
        "text": "Are you seeing how terribly our town is doing on the cultural awareness index? We used to be so much better back in my day.",
        "author": "Musa"
      },
      {
        "text": "I've come up with a quiz with some questions you should know the answers to. Are you ready to be quizzed?",
        "author": "Musa"
      }
    ],
    "choices": [{
    ...
    "path": "block1-correct",
    "messages": [{
        "text": "What does the greeting used by Muslims called 'As-salamu alaykum' translate to?",
        "author": "Musa"
      },
      {
    ...
    "path": "block2",
    "messages": [{
      "text": "Correct! It's beautiful and not too far from the 'peace and greetings' we say here in Narni",
      "author": "Musa"
    }],
    "choices": [{
      "path": "block3",
  ...
  },
  {
    "path": "block3-correct",
    "messages": [{
      "text": "Ding ding ding! Most Tibetans generally observe a form of Buddhism referred to as 'Tibetan Buddhism' or a collection of native traditions known as Bön",
      "author": "Musa"
    }],
    "choices": [{
      "path": "block4",
  ...
  },
  {
    "path": "block4",
    "messages": [{
        "text": "What is the annual festival carried out in Trinidad Tobago held on the Monday and Tuesday before Ash Wednesday?",
        "author": "Musa"
      },
      {
        "text": "A) J'ouvert",
  ...
  },
  {
    "path": "conclusion",
    "messages": [{
      "text": "Good job! Feel free to thank me for being enlightened by treating me to some deep fried bannock. See you soon hpoefully!",
      "author": "Musa"
    }],
    "choices": [{
        "path": "conclusion",
    ...
    "path": "busy",
    "messages": [{
      "text": "**Musa has enabled focused mode. She will not receive a notification for this message. Type 'URGENT' if you would like them to receive a notification for it**",
      "author": "Musa"
    }],
    "choices": [{
        "path": "busy",
