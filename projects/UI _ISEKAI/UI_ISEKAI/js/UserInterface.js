...
class UserInterface {
  ...
  initialize() {
    ...
    if (focusedData === false) {
      // focused default value is true. So if the user makes it false, its new default value is false
    ...
    if (musicData === true) {
      // musicPlaying's default value is false. So if the user makes it true, its new default value is true
